...
int main() {
    ...
    char *picName = "/Users/vvw/Documents/gh/x32/swt/swt/222t.raw";

    unsigned char buf[picWidth * picHeight * 3];
    ...
    for (size_t y = 0; y < picHeight; ++y) {
        for (size_t x = 0; x < picWidth; ++x) {
            ...
            trg::Rgb pixel = {static_cast<unsigned char>(buf[pos]), buf[pos + 1], buf[pos + 2]};
            a[y][x] = pixel;
        }
    }
